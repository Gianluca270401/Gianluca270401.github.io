...
// else{ error.style.display='none';  } 
// // function ValidarCorreo({ // if(txtcor.value=="" || txtCor.value==null){ 
// error.style.display="block'; 
// error.innerHTML+='<li>Por favor ingrese su correo</li>'; !! }else{ 
// error.style.display='none'; 
// // function Validar Sexo () { // if(sexo.value=="" || sexo.value==null){ 
// error.style.display='block'; 
// error.innerHTML+='<li>Por favor seleccione su sexo</li>'; 1 }else{ 
// error.style.display='none'; 
// // function ValidarEstado(){ // if(chkEst.checked==false) { 
